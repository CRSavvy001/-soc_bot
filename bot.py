...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        "Solana CA Forwarder is running. Add me to a group, and any Solana "
        "contract address posted there will be forwarded to the configured "
        "target chat as /soc <address>. Use /id in any chat to get its chat ID.",
    )
